...
func (f *Finder) GetOne(ctx context.Context,
	...
	if err != nil {
		...
		return nil, replicaerrors.NewReplicasErrorWithLevel(l, err)
	}
...
func (f *Finder) Exists(ctx context.Context,
	...
	if err != nil {
		...
		return false, replicaerrors.NewReplicasErrorWithLevel(l, err)
	}
...
func (f *Finder) CollectShardDifferences(ctx context.Context,
	...
	collectDiffForTargetNode := func(targetNodeAddress, targetNodeName string) (*ShardDifferenceReader, error) {
		...
		if diff.SetCount() == 0 {
			...
			}, replicaerrors.NewNoDiffFoundError(err)
		}
	...
	return &ShardDifferenceReader{}, replicaerrors.NewNoDiffFoundError(err)
}
